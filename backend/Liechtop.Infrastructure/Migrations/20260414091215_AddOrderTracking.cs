    ...
    public partial class AddOrderTracking : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_attribute_values", x => new { x.product_variant_id, x.attribute_value_id });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_product_attribute_values_product_variants_product_variant_id",
